...
<head>
    ...
    <meta name="description" content="Sobkaj.com">
...
<div class="c-wrapper c-fixed-components">
    <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav d-md-down-none">
            <li class="c-header-nav-item px-3"><a class="c-header-nav-link" href="{{ route('admin.dashboard') }}">Dashboard</a>
            </li>
        ...
        <ul class="c-header-nav ml-auto mr-4">
            ...
            <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link" href="#">
                    <svg class="c-icon">
                        <use
                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg')}}#cil-list-rich"></use>
                    </svg>
                </a></li>
            <li class="c-header-nav-item d-md-down-none mx-2"><a class="c-header-nav-link" href="#">
                    <svg class="c-icon">
                        <use
                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg')}}#cil-envelope-open"></use>
                    </svg>
                </a></li>
            <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#"
                                                      role="button" aria-haspopup="true" aria-expanded="false">
                    <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('assets/admin/img/avatars/6.jpg')}}"
                                               alt="user@email.com">
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right pt-0">
                    ...
                    <a class="dropdown-item" href="#">
                        ...
                        <svg class="c-icon mr-2">
                            <use
                                xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg')}}#cil-account-logout"></use>
                        </svg>
                        Logout</a>
                </div>
            </li>
    ...
    <div class="c-body">
                                ...
                                <div class="card-body card-body pb-0 d-flex justify-content-between align-items-start">
                                    ...
                                    <div class="btn-group">
                                        <button class="btn btn-transparent dropdown-toggle p-0" type="button"
                                            ...
                                            <svg class="c-icon">
                                                <use
                                                    xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg')}}#cil-settings"></use>
                                            </svg>
                                        </button>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg')}}#cil-user"></use>
                                                    </svg>
                                                    <div>Male</div>
                                            ...
                                            <div class="progress-group mb-5">
                                                <div class="progress-group-header">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg')}}#cil-user-female"></use>
                                                    </svg>
                                                    <div>Female</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-google"></use>
                                                    </svg>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-facebook-f"></use>
                                                    </svg>
                                                    <div>Facebook</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-twitter"></use>
                                                    </svg>
                                                    <div>Twitter</div>
                                            ...
                                            <div class="progress-group">
                                                <div class="progress-group-header align-items-end">
                                                    <svg class="c-icon progress-group-icon">
                                                        <use
                                                            xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-linkedin"></use>
                                                    </svg>
                                                    <div>LinkedIn</div>
                                    ...
                                    <table class="table table-responsive-sm table-hover table-outline mb-0">
                                        ...
                                        <tr>
                                            <th class="text-center">
                                                <svg class="c-icon">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/free.svg')}}#cil-people"></use>
                                                </svg>
                                            </th>
                                            <th>User</th>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="{{ asset('assets/admin/img/avatars/1.jpg')}}"
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg')}}#cif-us"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-cc-mastercard"></use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="{{ asset('assets/admin/img/avatars/2.jpg')}}"
                                                                           alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg')}}#cif-br"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-cc-visa"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="{{ asset('assets/admin/img/avatars/3.jpg')}}"
                                                                           alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg')}}#cif-in"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-cc-stripe"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="{{ asset('assets/admin/img/avatars/4.jpg')}}"
                                                                           alt="user@email.com"><span
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg')}}#cif-fr"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-cc-paypal"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="{{ asset('assets/admin/img/avatars/5.jpg')}}"
                                                                           alt="user@email.com"><span
                                                        class="c-avatar-status bg-success"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg')}}#cif-es"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-cc-apple-pay"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="c-avatar"><img class="c-avatar-img"
                                                                           src="{{ asset('assets/admin/img/avatars/6.jpg')}}"
                                                                           alt="user@email.com"><span
                                                        class="c-avatar-status bg-danger"></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/flag.svg')}}#cif-pl"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="clearfix">
                                            ...
                                            <td class="text-center">
                                                <svg class="c-icon c-icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('assets/admin/vendors/@coreui/icons/svg/brand.svg')}}#cib-cc-amex"></use>
                                                </svg>
                                            </td>
                                            <td>
                                                <div class="small text-muted">Last login</div>
        ...
        <footer class="c-footer">
            <div><a href="https://coreui.io">CoreUI</a> © {{ date('Y') }} Sobkaj.com</div>
            <div class="ml-auto">Powered by&nbsp;<a href="#">SoftBDLtd</a></div>
        </footer>
    </div>
</div>
